...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://stevegau:pCdaBZ1ehnzaSkF4sQFYgPRWQSWoVl6x@dpg-cfc9gbun6mpiero1lsbg-a.ohio-postgres.render.com/students_0h01'
db = SQLAlchemy(app)
#
